...
def draw_labels(boxes, confs, colors, class_ids, classes, img): 
	...
	for i in range(len(boxes)):
		if i in indexes:
			...
			os.system("start wmplayer \"C:\\Users\\mayur\\Desktop\\Main Project\\suspicious-activity-detection\\siren.wav\"");
...
def image_detect(img_path): 
	...
	message['Subject'] = 'Suspicious Activity Found'
	body = """Hello User, Pls find attached Image for Suspicious Activity."""
